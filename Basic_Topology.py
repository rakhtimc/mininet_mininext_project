...
class QuaggaTopo(Topo):
    ...
    # Create an instance of a host, called a quaggaContainer
        ...
        self.addLink(r1, r2, params1={'ip':'172.0.3.2/24'},intfName1='r1-eth1',intfName2='r2-eth0')
        self.addLink(r1, r3, params1={'ip':'172.0.4.2/24'},intfName1='r1-eth2',intfName2='r3-eth0')
        self.addLink(r2, r4, params1={'ip':'172.0.5.2/24'},intfName1='r2-eth1',intfName2='r4-eth2')
        self.addLink(r3, r4, params1={'ip':'172.0.6.2/24'}, params2={'ip':'172.0.6.1/24'},intfName1='r3-eth1',intfName2='r4-eth1')
        self.addLink(h2, r4, params1={'ip':'172.0.7.1/24'},params2={'ip':'172.0.7.2/24'},intfName1='h2-eth0',intfName2='r4-eth0')
